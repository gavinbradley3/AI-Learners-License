  ...
  quizBank: [
    {
      ...
      options: [
        ...
        { text: "Ask AI to write it and change several words", feedback: "Changing AI's wording does not make the original thinking Liam's." },
    ...
    },
    {
      ...
      options: [
        { text: "“Give me the answer only.”", feedback: "The answer removes the problem you are meant to solve." },
        { text: "“Solve it and make the steps look like mine.”", feedback: "Making AI work look like yours does not make it your work." },
        {
          text: "“Tell me what operation I should consider first without solving it.”",
          feedback: "A small hint keeps the important problem-solving with you.",
        },
        { text: "“Do the first half of the question.”", feedback: "AI is still doing part of the assessed thinking." },
      ],
      correctIndex: 2,
    ...
    },
    {
      ...
      options: [
        { text: "Brainstorming with AI is cheating", feedback: "AI brainstorming is not automatically inappropriate when the teacher allows it." },
        {
        ...
        { text: "AI is allowed for every assignment in that class", feedback: "Rules can change from one assignment to another." },
      ],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: [
        { text: "Use it because AI is available online", feedback: "Access does not equal permission." },
        { text: "Assume it is banned", feedback: "You do not need to assume either way. Ask." },
        {
        ...
        { text: "Use it but delete the chat later", feedback: "Deleting evidence does not make the use appropriate." },
      ],
      correctIndex: 2,
